...
process.env.TABLE_PASSWORD_RESETS = 'test-password-resets'
process.env.TABLE_AUDIT = 'test-audit'
process.env.TABLE_INVITES = 'test-invites'
process.env.TABLE_ENTRIES = 'test-entries'
